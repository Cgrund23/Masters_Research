...
class Controller:
    ...
    def __init__(self, Ts):
        ...
        class params():
            ...
            Y: set = {}
            sigma_f: float = 1
            length_scale: float = 1.5  # found from  loop demo will tune then adaptive
    ...
    def update(self, omega_l, omega_r, phi, x, y, path, points):
        ...
        u,l = (self.CBFobj.constraints_cost([v_des , error],x,y,phi,np.linalg.norm(U_GTG)))
        #print('location')
        #print(x,y)
