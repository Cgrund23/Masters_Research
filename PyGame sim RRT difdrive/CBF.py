...
class CBF:
    ...
    def g(self):
        ...
        gamma steer angle
        """
        return np.array([[np.cos(self.params.theta),0],
            [np.sin(self.params.theta),0],[self.params.theta,1]])[:2, :]
    ...
    def constraints_cost(self,u_ref,x,y,theta,v):
        ...
        self.uref = u_ref
        X_query = self.update_pose(x,y,theta,v).T[:, :2]
